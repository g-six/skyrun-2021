...
function Home() {
    ...
    const { data: translation } = useFetch(
        `/v1/contents?url=${encodeURI('https://cms.aot.plus/jsonapi/node/page_translation/be42cdfb-b39b-4b19-9bee-9b983024f917')}`,
        FetchMethods.GET,
        true,
        true
    )
    ...
    useEffect(() => {
        if (lang && translation.data?.attributes[lang]) {
            setTranslations({
                hero_line_2: getTranslation('hero_line_2', translation.data?.attributes[lang]),
                section_2_left_title: getTranslation('section_2_left_title', translation.data?.attributes[lang]),
                section_2_right_title: getTranslation('section_2_right_title', translation.data?.attributes[lang]),
                section_2_mid_left_title: getTranslation('section_2_mid_left_title', translation.data?.attributes[lang]),
                section_2_mid_right_title: getTranslation('section_2_mid_right_title', translation.data?.attributes[lang]),
                pricing_plans_title: getTranslation('pricing_plans_title', translation.data?.attributes[lang]),
            })
        }
    }, [translation, lang])
